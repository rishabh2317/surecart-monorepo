    ...
    for (const creator of creators) {
        await prisma.coupon.upsert({
            ...
            create: {
                ...
                imageUrl: "https://placehold.co/400x200/10b981/ffffff?text=Welcome+10%25+OFF",
            },
        });
        await prisma.coupon.upsert({
            ...
            create: {
                ...
                imageUrl: "https://placehold.co/400x200/f59e0b/ffffff?text=Festive+500+OFF",
            },
        });
    }
...
//# sourceMappingURL=04_coupons.js.map